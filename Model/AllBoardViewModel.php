...
namespace Kanboard\Plugin\AllBoardView\Model;

use Kanboard\Core\Base;
use Kanboard\Filter\TaskProjectFilter;
use Kanboard\Model\TaskModel;

class AllBoardViewModel extends Base
{
	...
	public function AllBoardViewGetProjectid($user_id) // Get all project_id where user has access
        {
	...
	public function AllBoardViewFullTasksList($project_id)
        {
	...
	public function AllBoardViewFullTasksListAll($projectAccess)
        {
